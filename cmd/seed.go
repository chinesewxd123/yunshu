	...
	return []model.Menu{
		...
		},
		{
			...
			Children: []model.Menu{
				...
				{Name: "Webhook 告警事件", Path: "/alert-events", Icon: "AlertOutlined", Sort: 2, Component: "alert-events-page", Status: 1},
			},
		},
		{
			Name:   "项目管理",
			...
			Children: []model.Menu{
				...
				{Name: "服务器管理", Path: "/project-servers", Icon: "HddOutlined", Sort: 2, Component: "project-servers-page", Status: 1},
				{Name: "服务配置", Path: "/project-services", Icon: "SettingOutlined", Sort: 3, Component: "project-services-page", Status: 1},
				{Name: "日志源配置", Path: "/project-log-sources", Icon: "FileSearchOutlined", Sort: 4, Component: "project-log-sources-page", Status: 1},
				{Name: "日志平台", Path: "/project-logs", Icon: "FileTextOutlined", Sort: 5, Component: "project-logs-page", Status: 1},
			},
		},
		{
			Name:   "系统管理",
		...
		},
		{
			...
			Children: []model.Menu{
				...
				{Name: "Event 事件", Path: "/events", Icon: "FileSearchOutlined", Sort: 19, Component: "events-page", Status: 1},
			},
		},
		{
