...
export const API_CATALOG_GROUPS: { title: string; routes: ApiCatalogRow[] }[] = [
  ...
  },
  {
    ...
    routes: [
      ...
      { method: "GET", path: "/api/v1/alerts/policies", summary: "告警策略列表", ui: "告警配置中心", auth: true },
      { method: "POST", path: "/api/v1/alerts/policies", summary: "创建告警策略", ui: "告警配置中心", auth: true },
      { method: "PUT", path: "/api/v1/alerts/policies/:id", summary: "更新告警策略", ui: "告警配置中心", auth: true },
      { method: "DELETE", path: "/api/v1/alerts/policies/:id", summary: "删除告警策略", ui: "告警配置中心", auth: true },
