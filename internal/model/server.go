...
type Server struct {
	...
	CloudZone              string `json:"cloud_zone" gorm:"size:64;not null;default:'';comment:云可用区"`
	CloudSpec              string `json:"cloud_spec" gorm:"size:128;not null;default:'';comment:云实例规格"`
	CloudConfigInfo        string `json:"cloud_config_info" gorm:"size:255;not null;default:'';comment:云实例配置摘要"`
	CloudOSName            string `json:"cloud_os_name" gorm:"size:255;not null;default:'';comment:云操作系统名称"`
	CloudNetworkInfo       string `json:"cloud_network_info" gorm:"size:255;not null;default:'';comment:云网络信息摘要"`
	CloudChargeType        string `json:"cloud_charge_type" gorm:"size:64;not null;default:'';comment:云实例计费模式"`
	CloudNetworkChargeType string `json:"cloud_network_charge_type" gorm:"size:64;not null;default:'';comment:云网络计费模式"`
	CloudTagsJSON          string `json:"cloud_tags_json" gorm:"type:text;comment:云标签JSON"`
	CloudPublicIP          string `json:"cloud_public_ip" gorm:"size:128;not null;default:'';comment:云公网IP"`
	CloudPrivateIP         string `json:"cloud_private_ip" gorm:"size:128;not null;default:'';comment:云内网IP"`
	CloudStatusText        string `json:"cloud_status_text" gorm:"size:64;not null;default:'';comment:云厂商原始状态"`
